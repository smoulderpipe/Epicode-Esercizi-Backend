...
public class DispositivoService {
    ...
    public Optional<Dispositivo> getDispositivoById(UUID id){
    ...
    public Dispositivo updateDispositivo(UUID id, DispositivoDto dispositivoDto){
        ...
        if(dispositivoOptional.isPresent()) {
            ...
            UUID dipendenteId = dispositivoDto.getDipendenteId();
    ...
    public String deleteDispositivo(UUID id){
        Optional<Dispositivo> dispositivoOptional = getDispositivoById(id);
        if(dispositivoOptional.isPresent()){
    ...
    public String assegnaDispositivo(UUID dispositivoId, UUID dipendenteId){
